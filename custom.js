...
function startQuiz() {
  ...
  form.innerHTML += `
    <p id="button_box">
      <button type="button" onclick="submitQuiz()">Check Now</button>
...
function submitQuiz(forceSubmit = false) {
  ...
  if (percentage >= 90) message = " <img src='one.gif'>Congratulations! You did an amazing job! Keep believing in yourself and never stop trying. Your hard work and dedication truly paid off!";
  else if (percentage >= 70) message = " <img src='two.gif'> Well done! With more effort, you'll improve even more! Keep moving forward and don’t give up. Every small step brings you closer to success!";
  else if (percentage >= 50) message = " <img src='three.gif'> Keep up the effort! You can do even better! Stay focused and keep pushing your limits. Success comes to those who never quit!";
  else message = " <img src='four.gif'> Don’t lose your enthusiasm! Try again, you can do it! Every failure is a step closer to success. Believe in yourself and keep moving forward!";

  document.querySelector("body").style.overflow = "hidden";
  document.querySelector(".overlay").style.display = "block";
  document.getElementById('scoreResult').style.display = 'block';
  document.getElementById('scoreResult').innerHTML = `
    <h3 style="font-weight: normal;">Your Score: ${score} out of ${total}</h3></br>
